    ...
    return (
        <div className='mb-5'>
            <div className='text-center'>
                ...
                <h1 className='winter-text'>Winter Resort</h1>
            ...
            <div className="row g-4 container mx-auto py-5">
                <div className="col-lg-4 col-sm-12">
                    <div className='winter-section'>
                        ...
                        <h4 className='winterImg-text'>China</h4>
                    </div>
                </div>
                <div className="col-lg-4 col-sm-12">
                    <div className='winter-section'>
                        ...
                        <h4 className='winterImg-text'>France</h4>
                    </div>
                </div>
                <div className="col-lg-4 col-sm-12">
                    <div className='winter-section'>
                        ...
                        <h4 className='winterImg-text'>Canada</h4>
                    </div>
                </div>
            </div>
        </div>
