            ...
            <div className="row container mx-auto">
                <div className="col-lg-3 col-sm-12">
                    <div className='text-center'>
                        {/* footer logo  */}
                        <img src={logo} className=' w-50 pb-2' alt="" />
                        <h2 className='text-white'>Vacation Travel</h2>
                ...
                <div className="col-lg-3 col-sm-12">
                    <div className='mt-4 text-white ms-2'>
                        ...
                        <h6 className='fs-5 pb-2'><i class="fas fa-envelope"></i> <span className='ms-1'>mehedi99@gmail.com</span></h6>
                        <h6 className='fs-5 pb-2'><i class="fas fa-phone-square-alt"></i> <span className='ms-1'>+880 1892054369</span></h6>
                        <h6 className='fs-5 pb-2'><i class="fas fa-map-marker-alt"></i> <span className='ms-1'>Agrabad,Chittagong,<br />
                            Bangladesh</span></h6>
                    </div>
                    <div>
                        <nav>
